...
public:
    ...
    //Returns vector of lines currently in text editor
    std::vector<std::string>& getVecLines();
    ...
    //incremements position of cursor 1 to the right
    ...
    //incremements position of cursor 1 below
    void incrementLine();

    //decremements position of cursor 1 above
    void decrementLine();

    // Returns the number of lines of text currently in the editor.
    int lineCount() const;

    //delete line of given line number
    void deleteLine(int lineNum);

    void createLine(int lineNum, std::string lineContents);

    //increase size of vector by 1
    void addLineToVector();
    ...
    //sets contents of given line with given string
    void setLineContents(const std::string& contents, int lineNumber);

    void incrementTotalLines();

    void decrementTotalLines();
